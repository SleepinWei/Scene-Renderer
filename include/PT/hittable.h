...
public:
	...
	virtual bool hasAABB() { return true; } // for infinte planes and directional lights, there's no aabb
...
class Directional : public hittable
{
public:
	Directional(const vec3 &_dir, const shared_ptr<PTMaterial> &m) : dir(_dir), mat_ptr(m) {}
	virtual bool hit(const Ray &r, double t_min, double t_max, hit_record &rec) const override;
	virtual bool bounding_box(double time0, double time1, AABB &output_box) const;
	virtual bool hasAABB() override { return false; }
